...
ActionButtons::ActionButtons( bool minBtn, bool maxBtn, bool closeBtn ) : QWidget() {
...
void ActionButtons::mousePressEvent( QMouseEvent *mEvent ) {
...
void ActionButtons::mouseMoveEvent( QMouseEvent *mEvent ) {

	repaint();
	mEvent->accept();
};

void ActionButtons::paintEvent( QPaintEvent *pEvent ) {
	...
	if ( closeBtnEnabled ) {
		...
		QPixmap closeIcon = QIcon( ":/icons/delete2.png" ).pixmap( 16, 16 );
