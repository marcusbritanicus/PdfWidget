/*
    *
    * GuiWidgets.cpp - Gui Widgets for MiniPDF
    *
*/
...
QWidget* Stretch::vertical( QWidget *parent ) {

	QWidget *vSpace = new QWidget( parent );
	vSpace->setSizePolicy( QSizePolicy::Preferred, QSizePolicy::Expanding );
	vSpace->setContentsMargins( QMargins() );

	return vSpace;
};

QWidget* Stretch::horizontal( QWidget *parent ) {

	QWidget *hSpace = new QWidget( parent );
	hSpace->setSizePolicy( QSizePolicy::Expanding, QSizePolicy::Preferred );
...
void LedLight::setModified( bool modified ) {
